  ...
  describe ".parse" do
    it "parses complex expressions with AND, OR, and nested conditions" do
      ...
      expect(node.as_json).to eq({
        ...
        operator:   :AND,
        conditions: [
          { field: "price", operator: :>, conditions: "10" },
          { field: "price", operator: :<, conditions: "20" },
          { field: nil, operator: :OR, conditions: ["Potter", "Rowling"] },
          { field: "name", operator: :"::", conditions: [
            { field: "food", operator: :":", conditions: "cereal" },
          ] },
          { field: "data", operator: :"=>", conditions: "exact" },
          { field: "data", operator: :"->", conditions: "partial" },
        ],
      })
    end
            ...
            conditions: [
              {
                ...
                conditions: [
                  { field: "price", operator: :<, conditions: "20" },
                  { field: "name", operator: :":", conditions: "Hello, World!" },
                ],
              },
              { field: "name", operator: :":", conditions: "Goodbye" },
            ],
          },
        ],
      })
    ...
    it "parses expressions with just words and a comparison" do
      ...
      expect(node.as_json).to eq({
        ...
        conditions: [
          "Wordle",
          { field: "timestamp", operator: :>, conditions: "2024-11-19T00:00:00-07:00" },
        ],
      })
    end
    ...
    it "parses nested values properly" do
      ...
      expect(node.as_json).to eq({
        ...
        operator:   :AND,
        conditions: [
          { field: "timestamp", operator: :>, conditions: "2024-11-12 07:00:00" },
          {
            field:      nil,
            operator:   :OR,
            conditions: [
