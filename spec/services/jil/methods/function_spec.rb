  ...
  describe "#function" do
    context "with no args" do
      ...
      it "executes the function innards twice" do
        ...
        expect(ctx[:vars].keys).to contain_exactly(:yf8a6, :a5699, :a5697, :re82f, :c01ab)
    ...
    context "with args" do
      ...
      it "allows using the variables within the function" do
        ...
        expect(ctx[:vars].keys).to contain_exactly(:yf8a6, :we83a, :k252c, :name, :time, :greeting, :j2594, :f1, :w5b8c, :w59e0, :f2, :l2d7b)
        expect(ctx[:vars]).to match_hash({
          yf8a6:    {
            class: :Function,
            value: {
