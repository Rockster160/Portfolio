...
ActiveRecord::Schema[7.1].define(version: 2026_09_04_215323) do
  ...
  create_table "box_images", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["box_key"], name: "index_box_images_on_box_key"
    t.index ["user_id"], name: "index_box_images_on_user_id"
  end
  ...
  create_table "buddy_usages", force: :cascade do |t|
    ...
    t.index ["env", "created_at"], name: "index_buddy_usages_on_env_and_created_at"
    t.index ["origin_uid"], name: "index_buddy_usages_on_origin_uid", unique: true
  ...
  create_table "chore_completions", force: :cascade do |t|
    ...
    t.index ["recorded_by_user_id"], name: "index_chore_completions_on_recorded_by_user_id"
  ...
  add_foreign_key "chore_completions", "users", column: "recorded_by_user_id"
