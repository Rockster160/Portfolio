...
Rails.application.configure do
  ...
  # Being truthy stops throwing a 500 for a missing asset
  ...
  config.action_cable.allowed_request_origins = ["https://ardesian.com", "https://whisper.ardesian.com", "https://fae.ardesian.com"]
