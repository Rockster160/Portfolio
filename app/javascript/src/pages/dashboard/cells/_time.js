...
Time.msSinceEpoch = function () {
  return Time.now().getTime();
};

Time.seconds = Time.second = function (n) {
  return n === 0 ? 0 : (n || 1) * 1000;
};
Time.minutes = Time.minute = function (n) {
  return n === 0 ? 0 : Time.seconds((n || 1) * 60);
};
Time.hours = Time.hour = function (n) {
  return n === 0 ? 0 : Time.minutes((n || 1) * 60);
};
Time.days = Time.day = function (n) {
  return n === 0 ? 0 : Time.hours((n || 1) * 24);
};
Time.weeks = Time.week = function (n) {
  return n === 0 ? 0 : Time.days((n || 1) * 7);
};
Time.months = Time.month = function (n) {
  return n === 0 ? 0 : Time.days((n || 1) * 30);
};
Time.years = Time.year = function (n) {
  return n === 0 ? 0 : Time.days((n || 1) * 365);
};
...
Time.msUntilNextHour = function (now) {
  ...
  return (
    (60 - now.getMinutes() - 1) * Time.minute() + Time.msUntilNextMinute(now)
  );
};
