...
export default class Bowler extends Reactive {
  constructor(element, js_id) {
    ...
    this.elementAccessor("hdcp", ".bowler-handicap", "value", function(value) {
      this.element.querySelector(`.bowler-option[data-bowler-option="hdcp"] .option-value`).innerText = value
    ...
    this.elementAccessor("avg", ".bowler-average", "value", function(value) {
      this.element.querySelector(`.bowler-option[data-bowler-option="avg"] .option-value`).innerText = value
    ...
    this.elementAccessor("bowlerName", ".bowler-name-field", "value", function(value) {
      ...
      this.element.querySelector(`.bowler-option[data-bowler-option="name"] .option-value`).innerText = value
