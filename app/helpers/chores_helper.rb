module ChoresHelper
  ...
  # The shapes themselves live in ApplicationHelper#icon_ref_tag — they stopped
  # being a chores idea the moment a second feature stored an icon. What stays
  # here is the broom: a `hicon:` whose upload has since been deleted resolves
  # to nothing, and a chore card still has to draw something.
  def rendered_icon(value)
    icon_ref_tag(value) || content_tag(:span, "🧹", class: "icon-placeholder")
  end
end
